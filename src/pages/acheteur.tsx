  ...
  return (
    <div className="mx-auto min-h-screen w-full bg-[#F0F2FC]">
      ...
      <div className="grid grid-rows-2">
        <main className="mx-auto px-8 col-span-1 mt-10 flex flex-row justify-evenly rounded-lg bg-white shadow">
          <section className="mb-10">
            ...
            {activeTab === "modules" && (
              <>
                <div className="max-h-96 overflow-y-scroll">
                  <ul className="mt-4 grid grid-cols-1 gap-4">
                    <li className="w-full rounded bg-[#F0F2FC] p-4">
        ...
        <div className="mx-auto px-8 col-span-3 mt-10 flex flex-row justify-evenly rounded-lg bg-white shadow">
          <button className="rounded-lg bg-[#C6CBE7] p-2 text-white">
            Retour
          </button>
        </div>
      </div>
